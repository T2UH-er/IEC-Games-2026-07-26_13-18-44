...
public class TrayScrollManager : MonoBehaviour
{
    ...
    public void AutoResizeTrayBoard()
    {
        ...
        float requiredWidth = (BlockSpawner.Instance.totalBlocksCount * BlockSpawner.Instance.slotSpacing) + boardPadding;
    ...
    public void CalculateScrollBounds()
    {
        ...
        {
            int N = BlockSpawner.Instance.totalBlocksCount;
            float S = BlockSpawner.Instance.slotSpacing;
            float halfN = N / 2f;
            maxX = halfN * S;                     
            minX = -((N - 1) - halfN) * S;       
        }
    ...
    private void Update()
    {
        ...
        if (Input.GetMouseButton(0) && InputManager.Instance != null && InputManager.Instance.selectedPiece == null)
        {
